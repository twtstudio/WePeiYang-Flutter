...
Future<String> saveImageFromUrl(String url, {String? path, bool? album}) async {
  final resultPath =
      await _channel.invokeMethod<String>("savePictureFromUrl", {"url": url, "path": path, "album": album});
  if (resultPath == null) {
