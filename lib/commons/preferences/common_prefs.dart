...
class CommonPreferences {
  ...
  var termStart = PrefsBean<int>('termStart', 1660492800);
  var termName = PrefsBean<String>('termName', '22231');
  var termStartDate = PrefsBean<String>('termStartDate', '2022-08-15');
