...
class _CreateObjectState extends State<CreateObject> {
              ...
              children: [
                ...
                FloatingActionButton(
                  onPressed: () => {
                    ...
                    (isDataComplete())?createObject(context):null,
                  },
                  child: Icon(
                    size: 6 * mm,
  ...
  createObject(BuildContext context) async {
    ...
    powerDebug(context);
    await ObjectLeaf.create("Object", ObjectData);
    //等待两秒
    //debugOutput(context, ObjectLeaf.log.toString());
    // 构建评分对象数据
    for (int i = 0; i < 5; i++) {
      objectLeafL[i]!.create("object", {
        "ObjectId": ObjectLeaf.dataM['create']!['succeed']!.toString(),
