...
class HotTopicsCard extends StatefulWidget {
  ...
  @override
  _HotTopicsCardState createState() => _HotTopicsCardState();
}

class _HotTopicsCardState extends State<HotTopicsCard> {
  @override
