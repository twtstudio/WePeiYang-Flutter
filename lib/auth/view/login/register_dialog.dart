            ...
            Expanded(
              child: DefaultTextStyle(
                ...
                child: ListView(physics: BouncingScrollPhysics(), children: [
                  ...
                  Text("一．引言\n" +
                      "微北洋产品和服务的提供者为天外天工作室（简称“天外天”或“我们”）。"+
                  ...
                  Text("2. 数据获取、使用规范\n" +
                      ...
                      "2.1.5 当您使用本应用并同意本隐私政策后，我们会采集您的唯一设备识别码（IMEI），通过IMEI对用户进行唯一标识，以便提供统计分析服务。\n"
                          "2.2 数据使用规范\n" +
                      ...
                      "以便进行用户新增等统计分析服务。详细内容请访问《【友盟+】隐私政策》(https://www.umeng.com/page/policy)。\n" +
                      ...
                      "2.3.3 微北洋使用了高德地图SDK，通过采集用户的位置信息来方便用户提交疫情防控信息。详情内容请访问《高德地图开放平台隐私权政策》(https://lbs.amap.com/pages/privacy)。\n"),
                  Text("3.用户内容\n" +
                      "3.1 用户内容\n" +
